  ...
  return (
    <div id='sliders'>
      ...
      <div className="mapbuttons">
                  <button className='butt5'onClick={()=>changepos(0)}>
                  <div className='changebutt'>Change initial position</div>
                  </button>
                  <button  className='clearbutt' onClick={()=>setclearRover(1)}>Clear rover path</button>
        </div>
